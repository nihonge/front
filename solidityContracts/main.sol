...
contract PrecompiledContractHandler {
    // 定义预编译合约地址
    address constant ENCRYPT_CONTRACT = 0x0000000000000000000000000000000000000021;
    address constant DECRYPT_CONTRACT = 0x0000000000000000000000000000000000000022;
    address constant COMPUTE_CONTRACT = 0x0000000000000000000000000000000000000023;
    address constant KEY_GENERATOR_CONTRACT = 0x0000000000000000000000000000000000000024;
